angular
.module('inspinia')
    .controller('CtrlIno', ['$rootScope', '$scope', '$state', '$http', '$stateParams', 'SweetAlert', function($rootScope, $scope, $state, $http, $stateParams, SweetAlert){
        $scope.loading = true;
    ...
    .controller('CtrlInoAgregar', ['$rootScope', '$scope', '$http', '$stateParams', 'SweetAlert', '$state', 'Upload', function($rootScope, $scope, $http, $stateParams, SweetAlert, $state, Upload){
        var date = new Date();
