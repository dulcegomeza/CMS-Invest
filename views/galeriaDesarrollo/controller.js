angular
.module('inspinia')
    .controller('CtrlDesarrollo', ['$rootScope', '$scope', '$state', '$http', '$stateParams', 'SweetAlert', function($rootScope, $scope, $state, $http, $stateParams, SweetAlert){
        $scope.loading = true;
    ...
    .controller('CtrlDesarrolloAgregar', ['$rootScope', '$scope', '$http', '$stateParams', 'SweetAlert', '$state', 'Upload', function($rootScope, $scope, $http, $stateParams, SweetAlert, $state, Upload){
        var date = new Date();
        ...
        $scope.agregar = function(){
            Upload.upload({
                ...
                if(responce.data.status){
                    $state.go("galeria.galeriaDesarrollo");
                }
            }, function (resp) {
