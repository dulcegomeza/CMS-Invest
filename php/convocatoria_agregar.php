...
$ruta = $servidor.$app.$carpeta_convocatorias;
$json = array();
        ...
        foreach ($imagenes["error"] as $key => $error) {
            if ($error == UPLOAD_ERR_OK) {
                ...
                if(file_exists($ruta.$name)){
                    $sqlImagen = "INSERT INTO convocatorias(idusuario, fecha_captura, ruta, activo) VALUES( '$idusuario', now(), '$carpeta_convocatorias$name','0')";
