...
function disallowMultipleSpaces(){
    return {
        restrict: 'A',
        link: function($scope, $element) {
            $element.bind('input', function() {
...
/**
*Sirve  para eliminar letras, solo  dejar escribir numeros  y  el punto decial
**/
...
angular
    ...
    .directive('numbersTextOnly',numbersTextOnly)
    .directive('numbersTextAcuteOnly',numbersTextAcuteOnly)
    .directive('toUpper',toUpper)
    .directive('disallowMultipleSpaces',disallowMultipleSpaces);
